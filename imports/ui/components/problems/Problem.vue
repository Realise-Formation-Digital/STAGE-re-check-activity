    ...
    <v-card>
      ...
      <v-card-text>
        <v-container>
          <v-row>
            <v-col cols="12">
              <v-text-field v-model="foundProblem.title" label="Problème*" required></v-text-field>
            </v-col>
            <v-col cols="12">
              <v-text-field v-model="foundProblem.description" label="Description*" required></v-text-field>
            </v-col>
          </v-row>
        </v-container>
